...
// Aviso de pré-venda das turmas do Cabeleireiro. Só aparece nos cursos vendidos pela Voomp —
// é deles a condição de pré-venda. O texto vem de um lugar só (src/lib/contracts.js) pra que
// card, página do curso e tela de aceite digam exatamente a mesma coisa.
...
export function ContractSummary({ course, selectedDate }) {
  ...
  // São 13 pagamentos iguais: a inscrição na Voomp mais 12 parcelas (ver PAGAMENTOS_CABELEIREIRO).
